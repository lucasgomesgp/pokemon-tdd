...
function App() {
  ...
  return (
    <PokemonContext.Provider
      value={{ pokemon: pokemonSearch, setPokemon: setPokemonSearch }}
    >
      <div className="min-h-screen max-w-full bg-background-home">
        ...
        <div className="flex flex-wrap items-center justify-center gap-8 p-8 animate-opacity">
          {pokemons.map((pokemon) => (
            <div
              className="flex flex-col bg-background-home shadow-lg p-2 items-center justify-center w-72 rounded-2xl border-2 hover:opacity-80 cursor-pointer transition-opacity animate-opacity"
                ...
                >
                  <g filter="url(#filter0_i_102_754)">
                    <path
                      ...
                      className={getColorOfPokemonCircle(
